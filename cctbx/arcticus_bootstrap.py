...
""".format(conda_env=self.use_conda))
  ...
  def add_configure(self):
    print("add_configure", self.use_conda)

    env = None
    if 'CCTBX_CONDA_USE_ENVIRONMENT_VARIABLES' in os.environ:
        env = {
          'PYTHONPATH': os.environ.get('PYTHONPATH',None),
          'LD_LIBRARY_PATH': os.environ.get('LD_LIBRARY_PATH',None),
          'DYLD_LIBRARY_PATH': os.environ.get('DYLD_LIBRARY_PATH',None),
          'DYLD_FALLBACK_LIBRARY_PATH': os.environ.get('DYLD_FALLBACK_LIBRARY_PATH',None)
        }
    ...
    if self.use_conda is not None:
      ...
      if 'CCTBX_CONDA_USE_ENVIRONMENT_VARIABLES' not in os.environ:
        env = {
          'PYTHONPATH': None,
